...
type
  TfrmMasterDetail = class(TForm)
    ...
    ItemsT: TTable;
    SubItemsT: TTable;
    ItemsTOrderNo: TFloatField;
    ItemsTItemNo: TFloatField;
    ItemsTPartNo: TStringField;
    ItemsTQty: TIntegerField;
    ItemsTDiscount: TFloatField;
    ItemsTQtyUnit: TStringField;
    ItemsTNotes: TStringField;
    ItemsTInStores: TFloatField;
    ItemsTOpDate: TDateField;
    ItemsTCompany: TStringField;
    ...
    procedure PageHeaderBand1BeforePrint(Sender: TQRCustomBand;
      var PrintBand: Boolean);
    procedure ItemsTCalcFields(DataSet: TDataSet);
  private
...
procedure TfrmMasterDetail.ItemsTCalcFields(DataSet: TDataSet);
begin
//  ItemsT.IndexFieldNames := ItemsTOpDate.AsString ;
end;
